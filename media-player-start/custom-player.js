...
timerWrapper.onclick = function (e) {
    var timerWrapperRect = timerWrapper.getBoundingClientRect();
    media.currentTime = ((e.x - timerWrapperRect.left) / (timerWrapperRect.right - timerWrapperRect.left)) * media.duration;
    media.play();
}
